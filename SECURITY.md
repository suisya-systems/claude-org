...
We take the security of claude-org seriously. If you discover a security issue, please report it privately so we can address it before public disclosure.

### Preferred channel: GitHub Private Vulnerability Reporting

Use [GitHub's private vulnerability reporting](https://github.com/suisya-systems/claude-org/security/advisories/new) feature. This is the only supported reporting channel and ensures the report is encrypted and only visible to maintainers. The same link is also surfaced in the issue chooser as the "Security report" contact link.
